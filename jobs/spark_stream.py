...
def create_spark_connection():
    ...
    try:
        s_conn = SparkSession.builder \
            ...
            .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.2.0,org.apache.kafka:kafka-clients:2.8.0,org.apache.spark:spark-token-provider-kafka-0-10_2.12:3.2.0,com.datastax.spark:spark-cassandra-connector_2.12:3.0.0") \
...
def connect_to_kafka(spark_conn):
    ...
    try:
        ...
        logging.error(f'Kafka dataframe creation failed due to exception: {e}')

    return spark_df

def create_selection_df_from_kafka(spark_df):
    if spark_df is None:
        logging.error('Spark DataFrame is None, cannot proceed with selection.')
        return None
...
if __name__ == '__main__':
    ...
    if spark_conn is not None:
        ...
        if selection_df is not None:
            ...
            logging.error('Failed to create selection DataFrame from Kafka data.')
    else:
